...
class Database(context: Context?) :
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val createTableIncome =
            "CREATE TABLE $TABLE_INCOME(INCOME_ID INTEGER PRIMARY KEY AUTOINCREMENT , INCOME_NAME TEXT, INCOME_DATE TEXT, INCOME_TYPE_NAME TEXT ,  USERNAME TEXT, INCOME_AMOUNT REAL)"
        db.execSQL(createTableIncome)
        val createTableEXPENSE =
            "CREATE TABLE $TABLE_EXPENSE(EXPENSE_ID INTEGER PRIMARY KEY AUTOINCREMENT , EXPENSE_NAME TEXT UNIQUE , EXPENSE_DATE TEXT, EXPENSE_TYPE_NAME TEXT, USERNAME TEXT, EXPENSE_AMOUNT REAL)"
