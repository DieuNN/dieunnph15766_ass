...
class Database(context: Context?) :
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val createTableEXPENSE =
            "CREATE TABLE $TABLE_EXPENSE(EXPENSE_ID INTEGER PRIMARY KEY AUTOINCREMENT , EXPENSE_NAME TEXT , EXPENSE_DATE TEXT, EXPENSE_TYPE_NAME TEXT, USERNAME TEXT, EXPENSE_AMOUNT REAL)"
